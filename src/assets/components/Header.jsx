...
function Header() {
    return (
        <div className="flex flex-col mb-24 justify-start gap-5 h-44 container mx-auto items-center shadow-xl shadow-blue-200 md:flex-row md:mb-0">
            ...
            <div className="flex items-center w-1/3 mt-5 bg-white border-2 border-blue-500 rounded-full px-4 py-2">
